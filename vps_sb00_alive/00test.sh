#!/bin/bash
#脚本来源：老王 https://github.com/eooce/scripts

SCRIPT_PATH="/root/00test.sh"  # 脚本路径

export HOST=${HOST:-'s11.serv00.com'}   # serv00服务器或IP
export TCP1_PORT=${TCP1_PORT:-'1234'}     # 四合一vmess端口
export TCP2_PORT=$TCP2_PORT:-'5678'}   # 四合一socks5端口
export UDP_PORT=${UDP_PORT:-'6789'}   # 四合一hy2端口
